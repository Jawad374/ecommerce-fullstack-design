  ...
  return (
    <footer className="bg-white border-t">
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-6 items-start">
          
          {/* Brand Column - Full width on mobile for better readability */}
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-600 my-4 max-w-sm">
              Best information about the company goes here but now lorem ipsum is
            </p>
            <div className="flex gap-3">
              {/* Social Icons - Kept consistent */}
              <a href="#" aria-label="Facebook" className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200">
                <svg className="w-4 h-4 text-gray-600" viewBox="0 0 24 24" fill="currentColor"><path d="M22 12C22 6.477 17.523 2 12 2S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.99H7.898v-2.888h2.54V9.797c0-2.507 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.772-1.63 1.562v1.875h2.773l-.443 2.888h-2.33v6.99C18.343 21.128 22 16.991 22 12z" /></svg>
              </a>
              <a href="#" aria-label="Twitter" className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200">
                <svg className="w-4 h-4 text-gray-600" viewBox="0 0 24 24" fill="currentColor"><path d="M22.46 6c-.77.35-1.6.58-2.46.69a4.3 4.3 0 001.88-2.37 8.59 8.59 0 01-2.72 1.04 4.28 4.28 0 00-7.3 3.9A12.14 12.14 0 013 4.79a4.28 4.28 0 001.32 5.71 4.24 4.24 0 01-1.94-.54v.05a4.28 4.28 0 003.43 4.2 4.3 4.3 0 01-1.93.07 4.28 4.28 0 003.99 2.97A8.6 8.6 0 012 19.54a12.13 12.13 0 006.56 1.92c7.88 0 12.2-6.53 12.2-12.2 0-.19 0-.39-.01-.58A8.7 8.7 0 0022.46 6z" /></svg>
              </a>
              <a href="#" aria-label="LinkedIn" className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200">
                <svg className="w-4 h-4 text-gray-600" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3A2 2 0 0121 5v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h14zM8.34 17.34V10.5H6.14v6.84h2.2zM7.24 9.36a1.28 1.28 0 110-2.56 1.28 1.28 0 010 2.56zM18 17.34v-3.36c0-1.8-1.02-2.64-2.38-2.64-1.1 0-1.58.6-1.86 1.02v-0.86H11.1c.03.57 0 6.84 0 6.84h2.2v-3.82c0-.2.01-.4.07-.55.15-.4.49-.82 1.06-.82.75 0 1.05.62 1.05 1.53v3.66H18z" /></svg>
              </a>
            </div>
          </div>
          ...
          {/* App Column - Spans 2 columns on mobile to avoid squishing */}
          <div className="col-span-2 md:col-span-1 flex flex-col items-start mt-4 md:mt-0">
            <div className="text-sm text-gray-700 mb-4 font-bold">Get app</div>
            <div className="flex flex-row md:flex-col gap-3 w-full">
              <a href="#" className="flex-1 md:w-full inline-flex items-center gap-2 bg-black text-white px-3 py-2 rounded-lg hover:bg-gray-900 transition-colors">
                <img src="/apple-512.png" alt="App Store" className="w-5 h-5 md:w-7 md:h-7 object-contain" />
                <div className="flex flex-col items-start leading-tight">
                  <span className="text-[10px] md:text-xs">Download on the</span>
                  <span className="text-sm md:text-lg font-semibold">App Store</span>
                </div>
              </a>
              <a href="#" className="flex-1 md:w-full inline-flex items-center gap-2 bg-black text-white px-3 py-2 rounded-lg hover:bg-gray-900 transition-colors">
                <img src="https://upload.wikimedia.org/wikipedia/commons/d/d0/Google_Play_Arrow_logo.svg" alt="Google Play" className="w-5 h-5 md:w-7 md:h-7" />
                <div className="flex flex-col items-start leading-tight">
                  <span className="text-[10px] md:text-xs uppercase">Get it on</span>
                  <span className="text-sm md:text-lg font-semibold whitespace-nowrap">Google Play</span>
                </div>
              </a>
            </div>
          </div>
